    ...
    return (
        <div className="flex flex-col items-center justify-center gap-6 p-6 sm:p-10">
            <div className="grid grid-cols-7 gap-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-md bg-gray-100 font-medium text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                    S
                </div>
                <div className="flex h-10 w-10 items-center justify-center rounded-md bg-gray-100 font-medium text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                    M
            ...
            <div className="grid grid-cols-7 gap-2">
                ...
                <div className="h-10 w-10 rounded-md bg-green-500" />
                <div className="h-10 w-10 rounded-md bg-yellow-500" />
